...
Mesh::Mesh(ID3D11Buffer * vertexBuffer, int vertCount, ID3D11Buffer * indexBuffer, int indexNum, ColliderType cType, bool isCollOffset) : Mesh(vertexBuffer, vertCount, indexBuffer, indexNum)
{
	collType = cType;
